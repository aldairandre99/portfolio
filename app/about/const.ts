const dataEnglish = [
  ...
  And open to working on projects that are working with ReactJS, React, Electron, Nextjs.
  `
]
...
const dataPortuguese = [
  ...
  E aberto para trabalhar em projetos que estejam trabalhando com ReactJS,React,Electron,Nextjs.
  `
]

export {
  dataEnglish,dataPortuguese
}